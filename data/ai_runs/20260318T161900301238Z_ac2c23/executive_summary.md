# AI batch enrichment - 20260318T161900301238Z_ac2c23
...
- review records: `1999`
- news records: `87`
- entities summarized: `212`
- brand distribution: `both`=43, `decathlon`=4529, `intersport`=1657

## Input runs

- review: `data\review_runs\20260318T083831998034Z_45415a`
- store: `data\store_runs\20260318T151654742345Z_49d39d`
...
- Top risks: `general_reputation_risk`=748, `brand_controversy`=308, `store_operations_issue`=239, `refund_friction`=134, `customer_service_issue`=38, `availability_risk`=24
- Top opportunities: `promo_engagement`=1224, `sport_category_interest`=97, `product_interest`=46, `brand_visibility_opportunity`=21, `community_momentum`=3
