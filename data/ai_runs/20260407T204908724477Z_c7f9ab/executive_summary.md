# AI batch enrichment - 20260407T204908724477Z_c7f9ab
...
- review records: `1536`
- news records: `101`
- entities summarized: `202`
- brand distribution: `both`=159, `decathlon`=4163, `intersport`=1296

## Input runs

- review: `data\review_runs\20260406T211216903688Z_034e83`
...
- x: `data\x_runs\20260407T204800549369Z_70d8ef`
- global: `data\global_runs\20260406T212451681222Z_4bf7e6`

## Cross-source watchouts

- Top risks: `general_reputation_risk`=665, `brand_controversy`=301, `store_operations_issue`=185, `refund_friction`=120, `product_safety_risk`=11, `product_quality_risk`=10
- Top opportunities: `promo_engagement`=1113, `product_interest`=115, `sport_category_interest`=83, `brand_visibility_opportunity`=12, `community_momentum`=5
...
- `decathlon` / `social` / `indianrunners`: 17 items, dominant sentiment neutral. Main opportunities: promo_engagement. Top themes: general_brand_signal, prix_promo.
- `both` / `social` / `PHitness`: 16 items, dominant sentiment neutral. Main opportunities: promo_engagement, sport_category_interest. Top themes: general_brand_signal, qualite_produit, prix_promo.
- `decathlon` / `social` / `deinfluencingPH`: 16 items, dominant sentiment neutral. Main opportunities: promo_engagement. Top themes: general_brand_signal, prix_promo.
- `both` / `social` / `Fahrrad`: 14 items, dominant sentiment neutral. Main opportunities: product_interest, promo_engagement. Top themes: general_brand_signal, velo_mobilite, prix_promo.
- `decathlon` / `social` / `wandern`: 14 items, dominant sentiment neutral. Main risks: general_reputation_risk. Main opportunities: promo_engagement. Top themes: general_brand_signal, prix_promo, livraison_stock.
- `both` / `social` / `StudyInTheNetherlands`: 13 items, dominant sentiment positive. Main opportunities: community_momentum, promo_engagement. Top themes: general_brand_signal, qualite_produit, magasin_experience.
