# Synthese globale Decathlon / Intersport - 20260312T170659106935Z_8cd529
...
- Tiktok: `data\tiktok_runs\20260312T170239751058Z_4d969a`
- X: non disponible
...
- Review sites: brands `decathlon`=20
...
- Sources review: `indeed`=20
- Scopes review: `employee`=20
- Brands review: `decathlon`=20
...
- TikTok brands: `decathlon`=1, `intersport`=1
- TikTok pillars: `reputation`=2
- TikTok source types: `account`=2
